...
export default function Donate({ route}) {
    ...
    const _donate = ()=>{
        fetch('https://us-central1-aiot-fit-xlab.cloudfunctions.net/bethechangedonate', {
              method: 'POST',
              headers: {
              'Content-Type': 'application/json',
              },
              body: JSON.stringify({"causeid": "1", "userid":"123","donation":donation,"type":"recurring","timeframe":value})
      })
   ...
   let controller;
    ...
    <View style={styles.container}>
         ...
         <Text style={styles.location}>
            ...
            <TextInput onChangeText={(value)=>{setDonation(value)}} style={{marginHorizontal:'20%', width:'80%', alignSelf:'center', fontFamily:'FuturaH', fontSize:20, height:50, borderRadius:5, borderWidth:1, borderColor:'#195F56', paddingLeft:20}} placeholder="$0+"></TextInput>
